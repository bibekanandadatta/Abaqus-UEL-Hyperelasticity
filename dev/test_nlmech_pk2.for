      include '../UEL-NLMech/src/uel_nlmech_pk2.for'

! **********************************************************************
! **********************************************************************

!     using ifort compiler compile the code from intel oneAPI terminal:
!     ifort /Qmkl -o nlmech_pk2 test_nlmech_pk2.for
!     this command will generate an executable call nlmech_pk2
...
! **********************************************************************
      ...
      if (case.eq.1) then
        ...
        fileName = 'NLmechDebug_1_PK2.dat'
      else if (case.eq.2) THEN
        write(*,*) 'testing case-II'
        fileName = 'NLmechDebug_2_PK2.dat'
        lam_1_App = two
      else
        write(*,*) 'wrong case'
        stop
      ...
      NJPROPS = 3               ! no of integer properties
